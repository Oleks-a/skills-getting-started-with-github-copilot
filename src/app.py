...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the varsity basketball team and compete in seasonal games",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Build teamwork and soccer skills with friendly matches and practice",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["ryan@mergington.edu", "jasmine@mergington.edu"]
    },
    "Art Studio": {
